...
export default function SignUp({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white/70 w-full max-w-xs p-6 sm:p-8 h-auto sm:h-150 rounded-xl shadow-md relative">
        ...
        <form className="space-y-3">
          <div>
            ...
            <div className='flex'>
              ...
              />
              <button type="button" className="confirm-btn w-1/3 mt-1 my-3  ml-2  bg-[#4d634b]
          ...
          <div>
            <label htmlFor="pw" className="block text-sm font-bold text-[#4d634b]">비밀번호</label>
            <input
              type="password"
              id="pw"
